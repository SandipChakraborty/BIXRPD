...
public class PeakDomain {
	 ...
	 * @param ycoValue
	 */
	public PeakDomain(String xcoValue, String ycoValue) {
		super();
	...
	public String toString() {
		return "PeakDomain [xcoValue=" + xcoValue + ", ycoValue=" + ycoValue + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PeakDomain other = (PeakDomain) obj;
		if (xcoValue == null) {
