...
public class DiffractionPatternDomain {

	public DiffractionPatternDomain() {
	 ...
	 * @param ycoValue
	 */
	public DiffractionPatternDomain(String xcoValue, String ycoValue) {
		super();
	...
	public String toString() {
		return "DiffractionPatternDomain [xcoValue=" + xcoValue + ", ycoValue=" + ycoValue + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DiffractionPatternDomain other = (DiffractionPatternDomain) obj;
		if (xcoValue == null) {
