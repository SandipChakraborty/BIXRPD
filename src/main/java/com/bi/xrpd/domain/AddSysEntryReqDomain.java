...
public class AddSysEntryReqDomain {
	...
	private List<DiffractionPatternDomain> diffractionPatternList;

	private List<PeakDomain> peakList;
	 ...
	 * @param peakList
	 */
	public AddSysEntryReqDomain(String label, String compoundName, String form, String dataSources,
			boolean referenceData, String batchOrLot, int notebookNumbe, String comments, String user, String role,
			List<DiffractionPatternDomain> diffractionPatternList, List<PeakDomain> peakList) {
		super();
		this.label = label;
	 ...
	 */
	public List<DiffractionPatternDomain> getDiffractionPatternList() {
	 ...
	 */
	public void setDiffractionPatternList(List<DiffractionPatternDomain> diffractionPatternList) {
		this.diffractionPatternList = diffractionPatternList;
	}
	 ...
	 * @return the peakList
	 */
	public List<PeakDomain> getPeakList() {
		return peakList;
	}
	 ...
	 */
	public void setPeakList(List<PeakDomain> peakList) {
		this.peakList = peakList;
	}
	...
	public String toString() {
		return "AddSysEntryReqDomain [label=" + label + ", compoundName=" + compoundName + ", form=" + form
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AddSysEntryReqDomain other = (AddSysEntryReqDomain) obj;
		if (batchOrLot == null) {
