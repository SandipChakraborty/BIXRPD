...
public class DiffractionPatternEvent {

	public DiffractionPatternEvent() {
	 ...
	 * @param ycoValue
	 */
	public DiffractionPatternEvent(String xcoValue, String ycoValue) {
		super();
	...
	public String toString() {
		return "DiffractionPatternEvent [xcoValue=" + xcoValue + ", ycoValue=" + ycoValue + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DiffractionPatternEvent other = (DiffractionPatternEvent) obj;
		if (xcoValue == null) {
